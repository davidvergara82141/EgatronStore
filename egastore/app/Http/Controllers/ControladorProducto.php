...
class ControladorProducto extends Controller
{
    ...
    public function comprarProducto($id)
    {
        ...
        if($compra->isEmpty() && $venta->isEmpty())
        {
            return view('producto.comprarProducto', compact('producto'));
        }

    return redirect()->route('home')->with('mensaje','Ya posee el producto: '.$producto->nombre.' Ya puede descargar
